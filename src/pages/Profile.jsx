      ...
      <div id="profile-container">
        <Card style={{ width: "30rem" }} id="profile-page">
          ...
          <Card.Body>
            ...
            <Card.Text>
              Add some details about yourself. Share more information about your
              interests or skills for recruiters to see.
            </Card.Text>
          </Card.Body>
          ...
          <Button onClick={handleDelete} variant="outline-secondary" size="lg">
            Delete Profile
          </Button>
        </Card>
      </div>
